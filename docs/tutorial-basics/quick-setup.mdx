...
:::caution
If you see lots of extra garbage characters in the terminal that is probably the VT100 code that updates the live monitor toolbar. Verify that your terminal supports VT100 mode and that VT100 mode is enabled.
::: 
