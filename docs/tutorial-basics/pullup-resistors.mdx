...
- The third line shows that 7.8mA is being consumed on VOUT. Since nothing is connected this represents the base current of the PPSU, opamp offset error and noise in the RP2040 analog to digital converter.
