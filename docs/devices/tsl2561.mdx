...
TSL2561 starts in power down mode. To start the device, write 0x03 to the control register.
...
0b00000010
- Gain (bit 4): set to 0 (1x)
- Integration time (bits 1:0): set to 10 (402ms)
