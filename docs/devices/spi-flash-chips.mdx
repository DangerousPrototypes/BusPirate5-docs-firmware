...
:::tip
SPI [flash adapters for SOP8, WSON8, and DIP8 chips](overview/spi-flash-adapters) are available for Bus Pirate 5. These adapters make it easy to connect SPI flash chips to the Bus Pirate.
:::
