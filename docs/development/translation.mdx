...
Bus Pirate 5 supports live language switching via the configuration menu. If a flash card is present the setting will be saved and loaded each time the Bus Pirate starts.
