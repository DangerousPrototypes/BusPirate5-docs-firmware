...
Bus Pirate 5 supports live language switching via the configuration menu. If an SD card is present the setting will be saved and loaded each time the Bus Pirate starts.
...
- Add a new case to the switch for you translation.  
